                ...
                <div class="et-panel-body">
                    <div class="et-row">
                        <div class="et-col-three-third">
                            <h3><?php _e( 'More WordPress Resources', ET_TD ); ?></h3>
                            <p> Themes Compatible with the Plugin :</p>

                            <p>Everest Timeline works best with every WordPress theme. It's even more remarkable when used with popular themes like VMagazine and AccessPress Parallax.</p>
