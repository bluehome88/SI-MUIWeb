...
require_once(PLUGIN_DIR . 'lib/helpers/google-fonts.php');

function kscf_get_all_fonts() {
	return array(
 ...
 * @return array
 */
function kscf_get_all_gf_weights() {
	return array(
		'300' => 'Light',
		'300i' => 'Light Italic',
		'400' => 'Regular',
 ...
 * @return array
 */
function kscf_get_all_gf_languages() {
	return array(
 ...
 * @return string
 */
function kscf_get_google_font_url($family, $weights, $languages) {
