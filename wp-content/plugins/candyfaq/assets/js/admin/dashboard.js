...
(function($) {
    ...
    var DASHBOARD_DATA = window.CandyFAQ_Dashboard;
    ...
    function onPeriodChange(e) {
        ...
        ui.fetch({
            action: ajaxPrefix + '_get_' + period + '_analytics'
    ...
    function initSearch() {
        ...
        $dashboard.on('mouseenter', '.fn-show-search-results', function(e) {
            ...
            ui.fetch({
                action: ajaxPrefix + '_get_hit_results',
                hit_id: hitId
        ...
        $dashboard.on('click', '.fn-reorder-search-results', function(e) {
            ...
            ui.fetch({
                action: ajaxPrefix + '_get_ordered_search_stats',
                field: field,
                order: order,
                page: pageCache
            }).then(function(response) {
        ...
        $dashboard.on('click', '.fn-search-pagination-item', function(e) {
            ...
            ui.fetch({
                action: ajaxPrefix + '_get_search_stats_page',
    ...
    function initReset() {
        $('.fn-mkb-reset-stats-btn').on('click', function(e) {
            ...
            ui.fetch({
                action: ajaxPrefix + '_reset_stats',
