...
(function($) {
    ...
    function renderShortcodeOptions(shortcode, values) {
        ...
        ui.fetch({
            action: ajaxPrefix + '_get_shortcode_options',
            shortcode: shortcode,
            values: values
    ...
    function tryToParseShortcodeOptions(selected) {
        ...
        var found = Object.keys(shortcodes).reduce(function (found, id) {
                var parsed = window.wp.shortcode.next('candy-' + id, selected);
        ...
        var id = shortcode.tag.replace('candy-', '');
    ...
    function handleShortcodeInsert(e) {
        ...
        var before = store.parsedShortcode ? '' : '[candy-' + store.shortcode + ']';
        var after = store.parsedShortcode ? '' : '[/candy-' + store.shortcode + ']';
     ...
     */
    tinymce.create('tinymce.plugins.CandyFAQ', {
        /**
        ...
        init : function(ed, url) {
            ...
            ed.addButton('candyfaq', {
                title : i18n['shortcodes'],
                cmd : 'candyfaq',
                image : url + '/../../img/mce-icon.png'
            });

            ed.addCommand('candyfaq', function() {
        ...
        getInfo : function() {
            return {
                ...
                authorurl : 'https://konstruktstudio.com/',
                infourl : 'https://konstruktstudio.com/',
                version : "1.0"
            };
        }
    });
    ...
    // Register plugin
    tinymce.PluginManager.add( 'candyfaq', tinymce.plugins.CandyFAQ );
})(jQuery);