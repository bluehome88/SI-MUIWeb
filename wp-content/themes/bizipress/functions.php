...
function my_scripts_method(){
	wp_enqueue_script( 'webp_replacer', get_template_directory_uri() . '/assets/js/webp_replacer.js?v='.time());
}

add_action( 'wp_enqueue_scripts', 'redirect_js_method' );
function redirect_js_method(){
	wp_enqueue_script( 'redirect', get_template_directory_uri() . '/assets/js/redirect.js?v='.time());
}

add_action('wp_head', function () {
	echo "<link rel='preload' as='style' href='".get_template_directory_uri()."/style.css'>"; 
});
