...
class Bizipress_Contact extends WP_Widget
{
    function __construct() {
        $widget_opt = array(
            'classname'     => 'bizipress_widget',
            'description'   => 'Bizipress Contact'
        );
        
        parent::__construct('xs-contacts', esc_html__('Bizipress Contact', 'bizipress'), $widget_opt);
    }
    ...
    function form($instance){
    	if(isset($instance['title'])){
            ...
            $title = esc_html__( 'Contact', 'bizipress' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'address' )); ?>"><?php esc_html_e( 'Address One:' , 'bizipress' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'address_one' )); ?>"><?php esc_html_e( 'Address Two:' , 'bizipress' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'mobile' )); ?>"><?php esc_html_e( 'Mobile:' , 'bizipress' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'email' )); ?>"><?php esc_html_e( 'Email:' , 'bizipress' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'fax' )); ?>"><?php esc_html_e( 'Fax:' , 'bizipress' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'open_time' )); ?>"><?php esc_html_e( 'Open Hour:' , 'bizipress' ); ?></label>
